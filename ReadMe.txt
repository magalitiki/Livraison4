...
NB: Pour ce livrable, les écrans et fonctionnalités suivants ont été impléméntés:
- l'enregistrement d'un article dans la base de données, 
- l'affichage des détails des articles enregistrés, 
- la recherche d'articles,
- l'enregistrement d'un fournisseur dans la base de données,
- l'affichage des détails des fournisseurs enregistrés,
